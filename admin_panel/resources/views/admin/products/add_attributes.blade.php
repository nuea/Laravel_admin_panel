        ...
        <div class="row-fluid">
            <div class="span12">
                <div class="widget-box">
                    ...
                    <form class="form-horizontal" enctype = "multipart/form-data" method="post" action="{{url('/admin/add-attributes/'.$productDetails->id)}}" name="add_attributes" id="add_attributes" >
                        {{ csrf_field() }}
                        ...
                        <table class="table table-bordered data-table">
                            ...
                            <tbody>
                                ...
                                <tr class="gradeX">
                                    ...
                                    <td class="center">
                                        <a rel="{{$attribute->id}}" rel1="delete-attribute" href="javascript:"id="" class="btn btn-danger btn-mini deleteRecord">Delete</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
